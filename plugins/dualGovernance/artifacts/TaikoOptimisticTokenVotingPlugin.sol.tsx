export const TaikoOptimisticTokenVotingPluginAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint32", name: "minVetoRatio", type: "uint32" },
      { indexed: false, internalType: "uint64", name: "minDuration", type: "uint64" },
      { indexed: false, internalType: "uint64", name: "l2AggregationGracePeriod", type: "uint64" },
      { indexed: false, internalType: "uint64", name: "l2InactivityPeriod", type: "uint64" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "_includeL2VotingPower", type: "bool" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        components: [
          { internalType: "uint64", name: "vetoEndDate", type: "uint64" },
          { internalType: "uint64", name: "snapshotTimestamp", type: "uint64" },
          { internalType: "uint32", name: "minVetoRatio", type: "uint32" },
          { internalType: "bool", name: "skipL2", type: "bool" },
        ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint64", name: "l2InactivityPeriod", type: "uint64" },
      { internalType: "uint64", name: "l2AggregationGracePeriod", type: "uint64" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_taikoL1", type: "address" },
      { internalType: "address", name: "_taikoBridge", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [],
    name: "taikoL1",
    outputs: [{ internalType: "contract TaikoL1", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
